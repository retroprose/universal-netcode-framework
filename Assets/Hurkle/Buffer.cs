...
namespace Hurkle
{
    ...
    {
        public static Scaler Bounce = (Scaler)1.0f;
        public static Scaler Overlap = (Scaler)1.0f;
        public static Scaler Space = (Scaler)0.005f;
        public static Scaler Bias = (Scaler)0.6f;
        public static Scaler Extend = (Scaler)1.0f;
    ...
    public struct DistanceQuery
    {
        ...
        public DistanceQuery(Body bA, Body bB, Fixture fA, Fixture fB)
        {
            ...
            var pos = (pA + fA.size) - ((pB - fB.size) + new Vector2(Slop.Overlap, Slop.Overlap));
            var neg = ((pB + fB.size) - new Vector2(Slop.Overlap, Slop.Overlap)) - (pA - fA.size);
    ...
    public struct Bounds
    {
        ...
        public Bounds(Cp.Handle e, ushort t, Vector2 p, Vector2 d, Vector2 s)
        {
            ...
            lower -= new Vector2(Slop.Extend, Slop.Extend);
            upper += new Vector2(Slop.Extend, Slop.Extend);
        }
